...
class GastosController extends Controller
{
    ...
    public function getIndex(Request $request)
    {
        ...
        $data['clasificaciones'] = ClasificacionIngresoEgreso::whereIndEgreso(true)->get();
        ...
        return view('consultas.gastos.index', $data);
    }

    public function postDatatable(DatatableResponse $handler, Request $request)
    {
        return $handler->create($request, MovimientosCuenta::aplicarFiltro($request->all())->gasto());
    }
}