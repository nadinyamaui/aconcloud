...
class GastoModificado extends Job implements ShouldQueue
{
    ...
    public function handle(Mailer $mailer)
    {
        ...
        $usuarios = $this->inquilino->usuarios()->whereIndRecibirGastosModificados(true)->get();
        $nombreInquilino = $this->inquilino->nombre;
        $asunto = 'Gasto modificado en ' . $nombreInquilino;
