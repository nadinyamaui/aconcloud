...
class IngresoRegistrado extends Job implements ShouldQueue
{
    ...
    public function handle(Mailer $mailer)
    {
        ...
        $usuarios = $this->inquilino->usuarios()->whereIndRecibirIngresosCreados(true)->get();
        $nombreInquilino = $this->inquilino->nombre;
        $asunto = 'Nuevo ingreso registrado en ' . $nombreInquilino;
